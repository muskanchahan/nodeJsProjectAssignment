...
let currentPage = 1;
const limit = 5; // Set the limit for number of books per page
...
function addComicToTable(book) {
    ...
    editBtn.style.backgroundColor = '#45a049'; // Orange color for edit button
    ...
    deleteBtn.style.backgroundColor = '#45a049';
